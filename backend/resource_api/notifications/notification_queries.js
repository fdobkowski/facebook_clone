const post_notification = (body) => `INSERT INTO notifications (id, sender_id, receiver_id, date, type, seen) 
                                     VALUES ('${body.id}', '${body.sender_id}', '${body.receiver_id}', '${body.date}', '${body.type}', false);`
